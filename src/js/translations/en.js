export default {
    ...
    menu: {
        search: 'Search ... (enter GOODWILL, OEM or other brands number)',
        dashboard: 'Dashboard',
        logout: 'Logout',
        profile: 'Profile',
        blank: 'Blank Page',
        ...
        home: 'Home',
        appSearch: 'Application',
        bestSellers: 'Best sellers',
        newItems: 'New Items',
        dimSearch: 'Dimensions search',
        orders: 'Заказы',
    ...
    catalog : {
        ...
        selectCarMark: 'Select manufacturer',
        selectCarModel: 'Select model series',
        selectCarModification: 'Select modification',
        model: 'Model series',
        engine: 'Engine',
        hp: 'HP',
        kw: 'KW',
